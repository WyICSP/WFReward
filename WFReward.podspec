...
Pod::Spec.new do |s|
  s.name             = 'WFReward'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WFReward.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wyxlh/WFReward'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wyxlh' => 'wy_wangyu163@163.com' }
  s.source           = { :git => 'https://github.com/wyxlh/WFReward.git', :tag => s.version.to_s }
